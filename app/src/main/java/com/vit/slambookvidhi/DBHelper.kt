...
class DBHelper(context: Context, factory: SQLiteDatabase.CursorFactory?) :
    ...
    /**
     * Add friend to slam book db
     */
    fun addFriendToSlamBook(name: String, dob: String, phone: String, hobby: String) {
    ...
    companion object {
        private const val DATABASE_NAME = "db_slam_book"

        //DB Version
        private const val DATABASE_VERSION = 1

        const val TABLE_NAME = "slam_book" //table name
